...
<%
	...
	<DIV ALIGN=LEFT>
		<P STYLE="margin-bottom: 0in"><h1><center>SET7</center></h1><B>
			
			<!-- Question 1--> 1.Which one of the following error will be handle by the operating system?
		</B>
...
<INPUT TYPE=RADIO NAME="q1" VALUE="default" CHECKED STYLE="width: 0.14in; height: 0.14in">Default
	...
	<DIV ALIGN=LEFT>
		...
		<!-- Question 2--> 2.Scientists Bristol have devised a machine that generates floating 3D shapes that you can feel, but can’t see with a blast of  ______________________
...
<INPUT TYPE=RADIO NAME="q2" VALUE="default" CHECKED STYLE="width: 0.14in; height: 0.14in">Default</P>
	...
	<DIV ALIGN=LEFT>
		...
		<!-- Question 3-->  3.Name the tactile feedback technology used in virtual reality which recreates the sense of touch by applying forces, vibrations, or motions to the user.
...
<INPUT TYPE=RADIO NAME="q3" VALUE="default" CHECKED STYLE="width: 0.14in; height: 0.14in">Default</P>
	...
	<DIV ALIGN=LEFT>
		<P STYLE="margin-bottom: 0in"><BR><B>
				...
				<!-- Question 4-->  4.A scripting language created by LaHood for virtual reality environments that allowed for the definition of complex 3D objects, environment attributes, object attributes, and triggers for cause-and-effect relationship.
...
<INPUT TYPE=RADIO NAME="q4" VALUE="default" CHECKED STYLE="width: 0.14in; height: 0.14in">Default</P>
	...
	<!-- Question 5--> 5.Which type of technology requires physiological interaction?
...
<INPUT TYPE=RADIO NAME="q5" VALUE="default" CHECKED STYLE="width: 0.14in; height: 0.14in">Default</P>
	...
	<DIV ALIGN=LEFT>
		...
		<!-- Question 6--> 6.Which one of the following is not shared by threads?
...
<INPUT TYPE=RADIO NAME="q6" VALUE="default" CHECKED STYLE="width: 0.14in; height: 0.14in">Default
	...
	<DIV ALIGN=LEFT>
		...
		<!-- Question 7--> 7.A new virtual reality project dubbed the “Re Vive.” Powered by SteamVR technology and is manufactured by ___________
		</B>
 ...
 <BR><INPUT TYPE=RADIO NAME="q7" VALUE="A" STYLE="width: 0.14in; height: 0.14in">
	...
	<!-- Question 8--> 8.To access the services of operating system, the interface is provided by the
	...
	<DIV ALIGN=LEFT>
		...
		<!-- Option D --> assembly instructions
	...
	<!-- Question 9--> 9.Who is the father of internet?
	...
	<!-- Question 10--> 10.News search engine introduced by rediff.com in 2012
	...
	<!-- Question 11--> 11.Which of the following is application of virtual reality 
	...
	<img src="<%=request.getContextPath()%>/images/set7-11a.gif">		<br>	
	...
	<img src="<%=request.getContextPath()%>/images/set7-11b.gif"> <br>
	...
	<img src="<%=request.getContextPath()%>/images/set7-11c.gif"> <br> 
	...
	<img src="<%=request.getContextPath()%>/images/set7-11d.gif"> <br>
	...
	<!-- Question 12-->  12.Which of the following technique is used in Midpoint Subdivision Algorithm
	...
	<img src="<%=request.getContextPath()%>/images/set7-12a.gif">		<br>	
	...
	<img src="<%=request.getContextPath()%>/images/set7-12b.gif"> <br> 
	...
	<img src="<%=request.getContextPath()%>/images/set7-12c.gif"> <br> 
	...
	<img src="<%=request.getContextPath()%>/images/set7-12d.gif"> <br>
	...
	<!-- Question 13--> 13.Which sense has least contribution  to virtual reality?
	...
	<img src="<%=request.getContextPath()%>/images/set7-13a.gif">		<br>
	...
	<img src="<%=request.getContextPath()%>/images/set7-13b.gif">		<br>
	...
	<img src="<%=request.getContextPath()%>/images/set7-13c.gif">		<br>
	...
	<img src="<%=request.getContextPath()%>/images/set7-13d.gif">		<br>
	...
	<!-- Question 14-->  14. Name the upcoming virtual reality headset produced by Sony Computer Entertainment.
	...
	<img src="<%=request.getContextPath()%>/images/set7-14a.gif">		<br>
	...
	<img src="<%=request.getContextPath()%>/images/set7-14b.gif">		<br>
	...
	<img src="<%=request.getContextPath()%>/images/set7-14c.gif">		<br>
	...
	<img src="<%=request.getContextPath()%>/images/set7-14d.gif">		<br>
...
<!-- Question 15-->  15.In bresenhan&rsquo;s algorithm error term is initialized to 
	...
	<img src="<%=request.getContextPath()%>/images/set7-15a.gif" >		<br>
	...
	<INPUT TYPE=RADIO NAME="q15" VALUE="B" STYLE="width: 0.14in; height: 0.14in">
	 <img src="<%=request.getContextPath()%>/images/set7-15b.gif">		<br>
	...
	<img src="<%=request.getContextPath()%>/images/set7-15c.gif">		<br>
	...
	<img src="<%=request.getContextPath()%>/images/set7-15d.gif">		<br>
